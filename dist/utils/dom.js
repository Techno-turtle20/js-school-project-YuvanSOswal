...
function isHTMLHeadingElement(element) {
    return element instanceof HTMLHeadingElement;
}
function isHTMLParagraphElement(element) {
...
function isHTMLSpanElement(element) {
    return element instanceof HTMLSpanElement;
}
function isHTMLUListElement(element) {
...
function getElementByIdOrThrow(id, typeGuard) {
